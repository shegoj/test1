...
@Entity
@Table(name = "UserDocUpload", catalog = "capacityplanning")
public class UserDocUpload implements java.io.Serializable{
	/**
	 * 
	 */
	...
	@Column(name = "value_", nullable = true,  columnDefinition="Decimal(10,0)")
