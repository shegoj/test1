    ...
    public StatsTab(ActivityOverview actOverview, ControlPanel cp) {
      ...
      /*  gbc.gridx = 1;
        ...
        */
        ...
        gbc.fill = GridBagConstraints.BOTH;
        gbc.anchor = GridBagConstraints.CENTER;
        panel1.add (new ActivityOverview().renderBarChart("Bandwidth Utilization",  "Month", "AVG Bandwdith/HTTP Rqst", "Bandwidth"),gbc);
        ...
        gbc.fill = GridBagConstraints.BOTH;
        gbc.anchor = GridBagConstraints.CENTER;
        panel1.add (new ActivityOverview().renderBarChart("Memory Utilization",  "Month", "% Utilization", "Memory"),gbc);
        ...
        panel1.add (new ActivityOverview().renderBarChart("CPU Utilization",  "Month", "% Utilization", "CPU"),gbc);
